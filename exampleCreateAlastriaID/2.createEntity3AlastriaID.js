...
const entity3Identity = new UserIdentity(web3, `0x${entity3Keystore.address}`, entity3PrivateKey)
...
function preparedAlastriaId() {
	const preparedId = transactionFactory.identityManager.prepareAlastriaID(web3, entity3Keystore.address)
	return preparedId
}

function createAlastriaId() {
	const txCreateAlastriaID = transactionFactory.identityManager.createAlastriaIdentity(web3, configData.entity3Pubk.substr(2))
...
async function main() {
	...
	const signedCreateTransaction = await entity3Identity.getKnownTransaction(createResult)
	...
	const entitySignedAT = tokensFactory.tokens.signJWT(signedAT, entity3PrivateKey)
	const aic = tokensFactory.tokens.createAIC(signedCreateTransaction,entitySignedAT,configData.entity3Pubk.substr(2));
