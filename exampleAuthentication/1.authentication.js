...
const verifyAT = tokensFactory.tokens.verifyJWT(signedAT, "04"+configData.entity1Pubk.substr(2))
...
// '04' means uncompressed key (more info at https://github.com/indutny/elliptic/issues/138)
const verifyAS = tokensFactory.tokens.verifyJWT(signedAS, "04"+configData.subject1Pubk.substr(2))
