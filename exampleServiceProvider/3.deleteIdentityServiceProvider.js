...
async function unlockAccount() {
	const unlockedAccount = await web3.eth.personal.unlockAccount(entity1Identity.address, configData.addressPassword, 3600)
...
async function mainDel() {
	...
	const transaction = await transactionFactory.identityManager.deleteIdentityServiceProvider(web3, configData.didEntity2)
