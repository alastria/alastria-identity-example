...
console.log('\n ------ Setting entity Aid ------ \n')
    ...
    async function mainSetAidEntity(){
        ...
        let transactionEntityAid = await transactionFactory.identityManager.setUrlCreateAID(web3, configData.didEntity1, "www.NombreEntidad.com/AID")
        let getKnownTxEntityAid = await adminIdentity.getKnownTransaction(transactionEntityAid)
        web3.eth.sendSignedTransaction(getKnownTxEntityAid)
