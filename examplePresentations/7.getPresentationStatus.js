...
if (
  configData.entity2PresentationStatus === undefined ||
  configData.subject1PresentationStatus === undefined
) {
...
const globalStatus = transactionFactory.presentationRegistry.getPresentationStatus(
  web3,
  configData.subject1PresentationStatus.status,
  configData.entity2PresentationStatus.status
)
web3.eth.call(globalStatus).then((result) => {
