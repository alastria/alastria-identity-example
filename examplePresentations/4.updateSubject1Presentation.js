...
const updateSubjectPresentation = transactionFactory.presentationRegistry.updateSubjectPresentation(web3, presentationHash.psmhash, configData.updateSubject1PresentationTo)
...
async function main() {
  const updateSubjP = await subject1Identity.getKnownTransaction(updateSubjectPresentation)
